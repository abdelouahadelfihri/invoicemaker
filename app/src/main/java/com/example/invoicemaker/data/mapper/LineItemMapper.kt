...
import com.example.invoicemaker.data.LineItem // adjust to wherever LineItem actually lives

fun InvoiceItemEntity.toUiModel(currencySymbol: String): LineItem {
